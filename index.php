...
">
        ...
        <div class="row gy-5 justify-content-center">
          ...
          <div class="col-12">
            <h2 class="text-center text-uppercase color mb-5 top-20">Цены</h2>
          </div>
        ...
        <div class="card border-dark">
          <div class="bg-light  p-5 rounded">
            <div class="col-sm-8 py-5 mx-auto">
              ...
              <p class="fs-5">Если вы хотите оставить заявку на видеосъёмку или у вас остались какие-либо вопросы, заполните форму или свяжитесь со мной</p>
              ...
              <p>
                ...
                <div class="btn-group">
          <a class="nav-link p-2" Whatsapp" href="whatsapp://send?phone=79854487143"><img src="img/whatsapp black-32 2.png"
              alt="Whatsapp" href="#"></a>
       
          <a class="nav-link p-2" Whatsapp" href="https://telegram.me/логинкомпании"><img src="img/telegram-2 black-32.png"
              alt="telegramm" href="#"></a>
              </div>
              <br>
              <br>
